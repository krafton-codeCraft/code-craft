...
import com.bknote71.basicwebsocketrobocode.robocode.proxy.BasicRobotProxy;
...
import static com.bknote71.basicwebsocketrobocode.util.Utils.*;
...
//        // than remaining distance, enabled the overdrive flag.
    ...
    private void scan(double lastRadarHeading, List<RobotPeer> robots) {
        ...
        startAngle = normalAbsoluteAngle(startAngle); // 양수화
    ...
    public String getNameForEvent(com.bknote71.basicwebsocketrobocode.robocode.core.RobotPeer otherRobot) {
    ...
    public void onDamaged(BulletPeer bulletPeer) {
        ...
        this.hp = Math.max(hp - bulletPeer.getPower(), 0);
