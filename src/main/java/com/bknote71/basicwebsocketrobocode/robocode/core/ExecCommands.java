...
public class ExecCommands {
    ...
    public ExecCommands(com.bknote71.basicwebsocketrobocode.robocode.core.ExecCommands origin, boolean fromRobot) {
    ...
    public void copyColors(com.bknote71.basicwebsocketrobocode.robocode.core.ExecCommands origin) {
        if (origin != null) {
