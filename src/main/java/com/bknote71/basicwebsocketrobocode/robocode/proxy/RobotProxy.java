package com.bknote71.basicwebsocketrobocode.robocode.proxy;

import com.bknote71.basicwebsocketrobocode.robocode.api.Robot;
import com.bknote71.basicwebsocketrobocode.robocode.core.*;
import com.bknote71.basicwebsocketrobocode.robocode.core.loader.RobotClassLoader;
import com.bknote71.basicwebsocketrobocode.robocode.event.EventManager;
import com.bknote71.basicwebsocketrobocode.robocode.robointerface.IBasicRobotPeer;
import com.bknote71.basicwebsocketrobocode.robocode.robointerface.IRobotPeer;
import com.bknote71.basicwebsocketrobocode.robocode.sample.FireBot;
...
public abstract class RobotProxy implements Runnable, IRobotPeer { // 로봇 피어와 1:1 대응
    ...
    private RobotClassLoader createLoader(RobotSpecification robotSpecification) { // 유저 네임 붙이기.
        return new RobotClassLoader(robotSpecification.getAuthor(), robotSpecification.getFullClassName());
    }
