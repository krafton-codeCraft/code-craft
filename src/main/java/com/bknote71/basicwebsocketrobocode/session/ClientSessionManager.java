...
public class ClientSessionManager {
    ...
    public static com.bknote71.basicwebsocketrobocode.session.ClientSessionManager Instance = new com.bknote71.basicwebsocketrobocode.session.ClientSessionManager();
